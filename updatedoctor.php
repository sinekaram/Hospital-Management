...
<body>
	...
	<h1 style="color:indigo;">UPDATE DOCTORS</h1><br>
 ...
 <!-- populate table from mysql database -->
		...
		<form action="updateddoctor.html" method="POST" role="form">
        <td><input type='hidden' name='docid' value='<?php echo $row['docid']?>'/>
        <input type='submit' class='btn'style="outline:none;"  name='submit' value='UPDATE' /></td>
