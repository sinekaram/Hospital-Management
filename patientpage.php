...
margin-top:20px;
  ...
  left:78%;
	...
	<body>
		...
		<a style="color:white;text-decoration:none;"href="patientlogin.html"><h4><i>LogOut</i></h4></a>
		</div>
	<header>
	   ...
	   <?php 
		...
		<nav>
			...
			<li><a href="patpreslist.php" >Report List</a></li>
			<?php
		...
		<center><h1 id="welcome" style="color:yellow;">WELCOME PATIENT</h1></center>
